...
The ModHub-format icon is separate: scripts/Make-ModIcon.py draws a geometric placeholder and exports BC1 DDS without mipmaps. It was created in an AI-assisted task and must not be represented as approved human-created ModHub submission artwork. The original desktop icon is unchanged.
